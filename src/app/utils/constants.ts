...
export const EMPTY_MAPPING = {'baseIRI': 'http://example.com/base/', 'namespaces': {}, 'subjectMappings': []};
...
export const PRISTINE_EDITOR = 'editorPristine';
export const DIRTY_EDITOR = 'editorDirty';
